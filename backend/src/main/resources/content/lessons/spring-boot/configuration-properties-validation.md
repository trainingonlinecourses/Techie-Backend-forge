...
1. `private String provider;` — app.payments.provider — required, non-empty
2. `private int timeoutSeconds = 30;` — app.payments.timeout-seconds — bounded
3. `private Retry retry = new Retry();` — nested group
4. getters/setters (required for binding) ...
5. getters/setters ...
