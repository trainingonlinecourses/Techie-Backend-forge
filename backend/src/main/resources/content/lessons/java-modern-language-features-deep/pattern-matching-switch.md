...
```java
// Without guards — verbose and easy to get wrong
...
```java
// A sealed hierarchy — the compiler knows all the subtypes
...
public class ShapeDemo {
    ...
    // A switch with guards — classify a number
    ...
    // Nested record pattern — extract the center of a circle
