...
1. returning a UserDetails whose getAuthorities() feeds role checks
2. Security wiring — Spring assembles: DaoAuthenticationProvider(userDetailsService, passwordEncoder). ProviderManager(List.of(daoProvider)). AuthenticationManager = ProviderManager
