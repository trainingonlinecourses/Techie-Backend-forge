...
1. Static nested class — no reference to LinkedList instance. This is what you should use by default
2. Inner class — holds reference to LinkedList instance. Use only when you need access to outer fields
