...
import com.example.payments.account.AccountAlreadyExists;
import com.example.payments.account.AccountNotFound;
import com.example.payments.auth.ConflictException;
import com.example.payments.transfer.DuplicateTransferException;
import com.example.payments.transfer.InsufficientFundsException;
import com.example.payments.transfer.SelfTransferException;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({InsufficientFundsException.class, SelfTransferException.class,
            DuplicateTransferException.class, AccountAlreadyExists.class, ConflictException.class})
